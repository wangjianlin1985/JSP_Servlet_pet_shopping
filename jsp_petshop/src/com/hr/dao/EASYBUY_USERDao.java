...
public class EASYBUY_USERDao
{
    ...
    public static EASYBUY_USER selectById(final String id) {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                u = new EASYBUY_USER(rs.getString("EU_USER_ID"), rs.getString("EU_USER_NAME"), rs.getString("EU_PASSWORD"), rs.getString("EU_SEX"), rs.getString("birthday"), rs.getString("EU_IDENTITY_CODE"), rs.getString("EU_EMAIL"), rs.getString("EU_MOBILE"), rs.getString("EU_ADDRESS"), rs.getString("EU_COURTY"), rs.getString("EU_LIKE"), rs.getInt("EU_STATUS"));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public static EASYBUY_USER selectAdmin(final String name, final String pwd) {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                user = new EASYBUY_USER(rs.getString("EU_USER_ID"), rs.getString("EU_USER_NAME"), rs.getString("EU_PASSWORD"), rs.getString("EU_SEX"), rs.getString("EU_BIRTHDAY"), rs.getString("EU_IDENTITY_CODE"), rs.getString("EU_EMAIL"), rs.getString("EU_MOBILE"), rs.getString("EU_ADDRESS"), rs.getString("EU_COURTY"), rs.getString("EU_LIKE"), rs.getInt("EU_STATUS"));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public static int insert(final EASYBUY_USER u) {
        ...
        final Object[] params = { u.getEU_USER_ID(), u.getEU_USER_NAME(), u.getEU_PASSWORD(), u.getEU_SEX(), u.getEU_BIRTHDAY(), u.getEU_IDENTITY_CODE(), u.getEU_EMAIL(), u.getEU_MOBILE(), u.getEU_ADDRESS(), u.getEU_COURTY(), u.getEU_LIKE(), u.getEU_STATUS() };
        return Basedao.exectuIUD(sql, params);
    }
    
    public static int update(final EASYBUY_USER u) {
        final String sql = "update EASYBUY_USER set EU_USER_NAME=?,EU_PASSWORD=?,EU_SEX=?,EU_BIRTHDAY=DATE_FORMAT(?,'%Y-%m-%d'),EU_IDENTITY_CODE=?,EU_EMAIL=?,EU_MOBILE=?,EU_ADDRESS=?,EU_COURTY=?,EU_LIKE=?,EU_STATUS=? where EU_USER_ID=?";
        final Object[] params = { u.getEU_USER_NAME(), u.getEU_PASSWORD(), u.getEU_SEX(), u.getEU_BIRTHDAY(), u.getEU_IDENTITY_CODE(), u.getEU_EMAIL(), u.getEU_MOBILE(), u.getEU_ADDRESS(), u.getEU_COURTY(), u.getEU_LIKE(), u.getEU_STATUS(), u.getEU_USER_ID() };
        return Basedao.exectuIUD(sql, params);
    }
