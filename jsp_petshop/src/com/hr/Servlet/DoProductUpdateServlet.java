...
public class DoProductUpdateServlet extends HttpServlet
{
    protected void service(final HttpServletRequest req, final HttpServletResponse resp) throws ServletException, IOException {
        ...
        final String id = req2.getParameter("id");
        final String pname = req2.getParameter("productName");
        final String pid = req2.getParameter("parentId");
        ...
        final EASYBUY_PRODUCT p = new EASYBUY_PRODUCT(Integer.parseInt(id), pname, desc, Integer.parseInt(price), Integer.parseInt(stock), Integer.parseInt(pid.split("-")[0]), Integer.parseInt(pid.split("-")[1]), fname);
        int count = 0;
        if (p != null) {
