...
<body>
	...
	<div id="position" class="wrap">
		您现在的位置：<a href="indexSelect">萌萌宠物店-网上宠物店</a> &gt; <a
			href="selectProductList">宠物分类</a> &gt; ${title }
	</div>
	<div id="main" class="wrap">
		<div class="lefter">
			<div class="box">
				...
				<dl>
					<dt>
						<a href="selectProductList">全部宠物</a>
					</dt>
					<c:forEach var="f" items="${flist}">
						<dt>
	...
	<div id="footer">Copyright &copy; 2019 萌萌宠物店-网上宠物店 All Rights
		Reserved. 沪ICP备案000001号</div>
</body>
</html>
