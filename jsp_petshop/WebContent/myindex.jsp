...
<title>个人主页 - 萌萌宠物店-网上宠物店</title>
<link type="text/css" rel="stylesheet"
	href="<%=request.getContextPath()%>/css/style.css" />
<script type="text/javascript"
	src="<%=request.getContextPath()%>/scripts/function-manage.js"></script>
<script type="text/javascript"
...
<body>
	...
	<div id="header" class="wrap">
		...
		<div class="help">
			<a href="<%=request.getContextPath()%>/">返回主页页面</a>
		</div>
		<div class="navbar">
			<ul class="clearfix">
				<c:choose>
	...
	<div id="position" class="wrap">
		您现在的位置：<a href="myindex.jsp">萌萌宠物店-网上宠物店</a> &gt; 修改个人信息
	</div>
	<div id="main" class="wrap">
		...
		<div class="main">
			<h2>修改用户</h2>
			<div class="manage">
				<form action="userModify" method="POST" onsubmit="return check()">
