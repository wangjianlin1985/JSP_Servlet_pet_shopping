...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li class="current"><a href="productSelect">宠物</a></li>
...
<div id="position" class="wrap">
	您现在的位置：<a href="index.jsp">萌萌宠物店-网上宠物店</a> &gt; 管理后台
</div>
	...
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				...
				<dd><em><a href="productAdd">新增</a></em><a href="productSelect">宠物管理</a></dd>
				<dt>订单管理</dt>
